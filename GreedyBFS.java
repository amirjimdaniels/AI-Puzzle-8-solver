...
public class GreedyBFS extends Agent {

    /*
        This is a helper function which is used to calculate the value of TreeNodes after they have been removed from the fringe
        for processing.


     */

    //Rather than the helper function calculating the F value of the node it only uses the manhattan distance or estimated distance to goal as a heuristic to make
    //choices off of, distinguishing this from A star.
    ...
    double CalculateFValue(TreeNode TreeNodeinput) {
        ...
        double Fvalue = calculateManhattan;
